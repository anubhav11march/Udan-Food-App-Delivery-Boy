...
public class Constant {
    ...
    public static final String LOGIN_DELIVERY_BOY_URL = "https://udanfood.com/public/api/delivery/login";
    public static final String GET_DELIVERY_ORDERS_URL = "https://udanfod.com/public/api/delivery/get-delivery-orders";
