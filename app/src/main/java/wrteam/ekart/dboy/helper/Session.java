...
import wrteam.ekart.dboy.activity.LoginActivity;
...
public class Session {
    ...
    public void createUserLoginSession(String fcmId, String id, String name, String email, String mobile, String balance, String status) {
